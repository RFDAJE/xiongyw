...
settings_wukuang() {
    ...
    NODES_IP_ADDRS=( "192.168.120.96 10.0.1.51 10.0.2.51" \
                     "192.168.120.97 10.0.1.52 10.0.2.52" \
                     "192.168.120.98 10.0.1.53 10.0.2.53" )
    ...
    TOOLS_DHCP_BIND_IP="192.168.120.80"
    # dhcp option 3, providing default gateway to clients
    TOOLS_DHCP_GATEWAY="192.168.120.1"
    # dhcp option 6, providing dns list to clients
    TOOLS_DHCP_DNS="192.168.120.1"
    # tftp root directory
