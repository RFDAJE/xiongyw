...
"    \n"
"    var table_width = window.getComputedStyle(document.getElementById(\"t\"+to_hide), null).getPropertyValue('width');\n"
"    table_width = parseInt(table_width) + 10; // get rid of px and add some headroom \n"
...
"    return \"<tr>\" + \n"
"           \"<td>\" + (d? x[0] : \"\") + \"</td>\" + \n"
"           \"<td>\" + (d? \"<b>\":\"\") + \"<a href='\" + encodeURI(x[4]) + \"'>\" + (d? \"/\" : \"\") + x[1] + \"</a>\" + (d? \"</b>\":\"\") + \"</td>\" +\n"
...
"\n"
"////////////////////////////////////////////////////////////\n"
"// added(bruin, 2013-11-22):\n"
"// in case some Array methods not available from IE \n"
"////////////////////////////////////////////////////////////\n"
"Array.prototype.filter = Array.prototype.filter || function (f){\n"
"    var result = [];\n"
"    var len = this.length;\n"
"    for(var i = 0; i < len; i ++){\n"
"        if((i in this) && f.call(undefined, this[i])){\n"
"            result.push(this[i]);\n"
"        }\n"
"    }\n"
"    return result;\n"
...
"    for(var i = 0; i < len; i ++){\n"
"        if(i in this){\n"
"            result[i] = f.call(undefined, this[i], i, this);\n"
"        }\n"
"    }\n"
"    return result;\n"
"}\n"
"\n"
"Array.prototype.reduce = Array.prototype.reduce || function (f, init){\n"
"    var len = this.length;\n"
"    var acc = undefined;\n"
"    var i = 0;\n"
"\n"
...
"        acc = init;\n"
"    }else{ // set acc as the first \"meaningful\" element in a\n"
"        for(; i < len; i ++){\n"
"            if(i in this){\n"
"                acc = this[i++]; // note: a[i] could be undefined or null!\n"
"                break;\n"
"            }\n"
"        }\n"
"        if(i == len){ // nothing reminded for f() to reduce/fold \n"
"            return acc;\n"
"        }\n"
"    }\n"
"\n"
...
"    for(;i < len; i ++){\n"
"        if(i in this){\n"
"            acc = f.call(undefined, acc, this[i], i, this);\n"
"        }\n"
"    }\n"
"    return acc;\n"
"}\n"
...
#define MAX_HEAD_SIZE           (sizeof(s_part1) + 1024)
#define MAX_TAIL_SIZE           (sizeof(s_part3) + 1024)
