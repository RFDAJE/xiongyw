...
//yingchun.marry(sun_shaozu); // 后40回
...
shipout_lineage(mou, "hlm_jia", "贾府人物关系简图", "人名后面带下划线的数字表示十二正钗的序号，图中不包括史湘云~\underline{5}和妙玉~\underline{6}。本图参考人文1996年第二版编制于2016年4月22日。", 15cm, pack=true);
