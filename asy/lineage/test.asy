...
person zhao_jiasong  = person.person(true,  "赵", "家松",       question, question);
person zhao_jiasong_wife  = person.person(false, unknown, unknown2, question, question );
person zhao_cheng_x  = person.person(false, "赵", "承"+unknown,       question, question);
person zhao_chengbin = person.person(true,  "赵", "承斌",       "1811",   "1899");
...
person zhao_zuxin    = person.person(true,  "赵", "鑫",       question, blank);
