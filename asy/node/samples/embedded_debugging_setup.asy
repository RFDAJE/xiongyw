...
node E2T_003e3ec8                     = node("E2T", "d");
node Emulator_003e2920                = node("Emulator", "d");
node H2E_003e4460                     = node("H2E", "d");
...
node JTAG_003e3ee8                    = node("JTAG", "d");
node SWD_003e28f0                     = node("SWD", "d");
E2T_003e3ec8.attach(JTAG_003e3ee8);
E2T_003e3ec8.attach(SWD_003e28f0);

node BDI1000_003e2958                 = node("BDI1000", "d");
node BDI2000_003e2988                 = node("BDI2000", "d");
node BDI3000_003e29b8                 = node("BDI3000", "d");
node H-Link_003e29e8                  = node("H-Link", "d");
node J-Link_003e2a18                  = node("J-Link", "d");
node RealView_003e43e0                = node("RealView", "d");
node U-Link_003e4400                  = node("U-Link", "d");
node Wiggler_003e4430                 = node("Wiggler", "d");
Emulator_003e2920.attach(BDI1000_003e2958);
Emulator_003e2920.attach(BDI2000_003e2988);
Emulator_003e2920.attach(BDI3000_003e29b8);
Emulator_003e2920.attach(H-Link_003e29e8);
Emulator_003e2920.attach(J-Link_003e2a18);
Emulator_003e2920.attach(RealView_003e43e0);
Emulator_003e2920.attach(U-Link_003e4400);
Emulator_003e2920.attach(Wiggler_003e4430);

node Parallel_Interface_003e4490      = node("Parallel", "d");
node Twist_Pair_003e4748              = node("Twist Pair", "d");
node USB_003e4780                     = node("USB", "d");
...
Host_003e47b0.attach(ARM_003e47e0);
...
Host_003e47b0.attach(MIPS_003e4f30);
Host_003e47b0.attach(PPC_003e4f60);
...
node J-Link_Gdb_Server_003e4bc8       = node("J-Link Gdb Server", "d");
node OpenOCD_003e4c08                 = node("OpenOCD", "d");
Gdb_Server_003e4b90.attach(J-Link_Gdb_Server_003e4bc8);
